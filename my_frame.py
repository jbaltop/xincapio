...
class MyFrame(wx.Frame):
    ...
    def init_ui(self):
        ...
        i = 0
        blank_space = wx.StaticLine(panel, 0, size=(0, 0), style=wx.LI_HORIZONTAL)
        sizer.Add(blank_space, pos=(i, 0), flag=wx.DOWN, border=Style.section_border)
        i += 1

        blank_space = wx.StaticLine(panel, 0, size=(0, 0), style=wx.LI_HORIZONTAL)
        sizer.Add(blank_space, pos=(i, 0), flag=wx.RIGHT, border=Style.section_border)
        ...
        blank_space = wx.StaticLine(panel, 0, size=(0, 0), style=wx.LI_HORIZONTAL)
        sizer.Add(blank_space, pos=(i, 2), flag=wx.RIGHT, border=Style.h1_border)

        for network in self.system_info["network"]:
            line = wx.StaticText(panel, label="Name")
            line.SetFont(key_font)
            sizer.Add(line, pos=(i, 3), flag=wx.UP | wx.DOWN, border=Style.default_border)

            blank_space = wx.StaticLine(panel, 0, size=(0, 0), style=wx.LI_HORIZONTAL)
            sizer.Add(blank_space, pos=(i, 4), flag=wx.RIGHT, border=Style.key_border)

            line = wx.StaticText(panel, label=network["name"])
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)

            blank_space = wx.StaticLine(panel, 0, size=(0, 0), style=wx.LI_HORIZONTAL)
            sizer.Add(blank_space, pos=(i, 6), flag=wx.RIGHT, border=Style.section_border)
            i += 1
        ...
        sizer.Add(hline, pos=(i, 0), span=(1, 7), flag=wx.ALIGN_CENTER | wx.EXPAND)
        i += 1
        ...
        if self.system_info["os"] == "Linux":
            ...
            line = wx.StaticText(panel, label=self.system_info["boot_disk"]["mount_point"])
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)
            ...
            line = wx.StaticText(panel, label=str(self.system_info["boot_disk"]["serial_number"]))
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)
            ...
            line = wx.StaticText(panel, label=self.system_info["boot_disk"]["device_id"])
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)
            ...
            line = wx.StaticText(panel, label=str(self.system_info["boot_disk"]["index"]))
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)
            ...
            line = wx.StaticText(panel, label=self.system_info["boot_disk"]["serial_number"])
            sizer.Add(line, pos=(i, 5), flag=wx.UP | wx.DOWN, border=Style.default_border)
